...
func main() {
	...
	info := component.BuildInfo{
		...
		Description: "span-report-collector aggregates the number of received Spans per service.name and deployment.environment.name, and exports hourly, daily, and monthly statistics to a file.",
		Version:     "1.0.0",
	}
